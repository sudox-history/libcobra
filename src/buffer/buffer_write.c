...
void cobra_buffer_write(cobra_buffer_t *buffer,
                        uint8_t *data,
                        uint64_t length) {
...
void cobra_buffer_write_uint(cobra_buffer_t *buffer,
                             uint64_t number,
                             int length) {
    ...
    cobra_buffer_write(buffer, number_buffer + sizeof(uint64_t) - length,
                       length);
}
